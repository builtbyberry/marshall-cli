...
/**
 * OAuth 2.1 login against the Marshall store — authorization code + PKCE, with the
...
/** The hosted store. Mirrors the plugin hardcoding its MCP url in 0.8.1: Marshall is a
...
<h1 style="font-size:1.25rem">${ok ? 'Signed in to Marshall' : 'Sign-in failed'}</h1>
